...
void test_direct_path(){
    ...
    printf("\n10 -> 10:\n");
    if(! find_direct_path(search_station(root, 10), search_station(root, 10)) ) { printf("PATH NOT FOUND!\n");}
...
void test_inverse_path(){
    ...
    printf("\n20 -> 20:\n");
    if(! find_inverse_path(search_station(root, 20), search_station(root, 20)) ) { printf("PATH NOT FOUND!\n"); }
